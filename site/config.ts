// Site-wide links and copy. One place to change them.

export const SITE_NAME = "The GAP Build Vault";

export const TAGLINE =
  "Full AI + automation builds for B2B client acquisition. No email wall. The whole thing.";

export const REPO_URL = "https://github.com/gary-chakraborty/gap-build-vault";

export const AUTHOR_NAME = "Built by GAP";
